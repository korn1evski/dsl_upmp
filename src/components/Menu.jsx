...
function Menu({isShown, setIsShown}) {
    ...
    return (
        <div
            className={isShown ? 'bg-leftMenu-gradient pl-[20px] w-full md:w-1/4 2xl:w-1/5 color duration-300 transition-w ease-in-out flex justify-between flex-col' : 'w-0 bg-leftMenu-gradient bg-blend-darken from-[#000] to-[#4d1f00] duration-300 transition-w ease-in-out'}>
            {isShown ? <div className={'w-full h-full relative'}>
                <div>
